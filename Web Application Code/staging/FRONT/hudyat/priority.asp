			...
			<div class="toolbar" id="kt_toolbar">
				...
				<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
					...
					<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
						<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Priority File
							<!--begin::Separator-->
									...
									<div class="card-header mt-5">
										...
										<div class="card-toolbar my-1">
											...
											<div class="card-toolbar">
												<a href="#!" class="btn btn-bg-light btn-active-color-primary btn-sm"  onclick='addrecord()'>New</a>
											</div>
										</div>
										<!--begin::Card toolbar-->
									</div>
...
<script src="priority.js?t=<% Write(nocache_time) %>"></script>
