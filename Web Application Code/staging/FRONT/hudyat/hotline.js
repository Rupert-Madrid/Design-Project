...
$(document).ready(function () {
  ...
  var dataSource = new kendo.data.DataSource({
          transport: {
              ...
              update: {
                  url: crudServiceBaseUrl + "/HotlineFile.ashx?action=UPDATE",
                  dataType: "json"
              },
              destroy: {
                  url: crudServiceBaseUrl + "/HotlineFile.ashx?action=DELETE",
                  dataType: "json"
              },
              create: {
                  url: crudServiceBaseUrl + "/HotlineFile.ashx?action=SAVE",
                  dataType: "json"
              },
...
//           pageSize: 20,
  ...
  $("#grid").kendoGrid({
      ...
      columns: [
          ...
          { field:"CONTACT_PERSON", title: "Contact", width: "170px" },
    ...
    edit: function(e) {
      ...
      e.container.find(".k-edit-field:last").hide();
        if (e.model.isNew() === false) {
          e.container.find("input[name=HOTLINE_CODE]").css({ "background-color": "lightgray" });
